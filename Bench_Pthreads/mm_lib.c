...
* de hacer el balanceo o la división de cargas para cada hilo
* usando el API. La idea principal es no hacer la división de forma
* manual como Pthreads, sino que sea transparente por parte del API
* de OpenMP 
*/
...
/* Benchmark 07: Para aprovechar el principio de localidad espacial
* se transformara la multiplicacion de matrices a filas por filas
*/
